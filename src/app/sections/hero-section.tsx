...
const HeroSection = () => {
  return (
    <div className="relative flex flex-col items-center justify-center overflow-y-clip px-2 pt-[60px] md:pt-[90px]">
      ...
      <div className="absolute lg:bottom-[30%] bottom-10 -z-[4] hidden aspect-square w-[556px] rounded-full bg-[#602A9A] blur-[400px] md:block" />

      <div className="absolute bottom-[120px] lg:bottom-[32%] -z-[1] hidden aspect-square w-[384px] lg:w-[420px] xl:w-[500px] rounded-full bg-[#622A94] lg:blur-[140px] blur-[105px] md:block" />
      ...
      <div className="mt-3 flex flex-col items-center justify-center space-y-[16px] text-center">
        ...
        <p className="max-w-[90%] leading-[28px] sm:text-[18px] lg:text- md:max-w-[65%]">
            ...
            <div className="hero-ellipse w-[70%]">
              <div className="relative h-full w-full">
                <Image
                  ...
                  width={11}
                  height={11}
                  className="absolute top-0 lg:size-[14px] left-1/2 -translate-y-1/2"
                />
              </div>
            </div>
