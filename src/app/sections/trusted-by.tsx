...
const TrustedBy = () => {
  return (
    <div className=" bg-background px-3 py-7 flex flex-col justify-center gap-10">
      <p className=' text-center leading-[26px] text-white/70'>Trusted by the world’s most innovative teams</p>
